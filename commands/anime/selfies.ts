...
export default commandModule({
	...
	plugins: [publish()],
	description: ':boobas: but phone photo lol i love my life',
	//alias : [],
	execute: async (ctx, args) => {
		await ctx.interaction.deferReply({ephemeral: true})
		let request = await axios('https://api.waifu.im/random/?is_nsfw=false&selected_tags=selfies').then(res => res.data)
